...
router.get(
  "/get_general_ledger/:party_id/:date_from/:date_to",
  function (req, res) {
    ...
    app.conn.query(query1, function (err, result1) {
      if (err) {
        ...
        query2 =
          "select * from ledger where l_date>='" +
          date_from +
          "' AND l_date<='" +
          date_to +
          "' AND party_id = '" +
          ...
          if (err) {
            ...
            for (let i = 0; i <= result2.length; i++) {
              ...
              if (i < result2.length) {
                ...
                dataset.total_seller_weight = dataset.total_seller_weight
                  .toFixed(2)
                  .toLocaleString();
                ...
                dataset.total_buyer_weight = dataset.total_buyer_weight
                  .toFixed(2)
                  .toLocaleString();
                ...
                dataset.total_debit = dataset.total_debit
                  .toFixed(2)
                  .toLocaleString();
                ...
                dataset.total_credit = dataset.total_credit
                  .toFixed(2)
                  .toLocaleString();

                dataset.balance = result2[i].l_balance;
                dataset.balance = dataset.balance.toFixed(2).toLocaleString();
...
function addIntoLedger(data) {
  return new Promise(function (resolve, reject) {
    query1 =
      "select l_balance from ledger where party_id='" +
      data.party_id +
    ...
    app.conn.query(query1, function (err, result1) {
      ...
      (query2 =
        "insert into ledger(party_id,gp_number,cv_number,l_description,l_seller_weight,l_buyer_weight,l_rate,l_debit,l_credit,l_balance,l_date)" +
        +"values('" +
        data.party_id +
        "','" +
        data.gp_number +
...
function addIntoLedgerWithGP(data) {
  return new Promise(function (resolve, reject) {
    ...
    app.conn.query(query1, function (err, result1) {
      ...
      data.l_balance = data.l_balance + balance;
      (query =
        "insert into ledger(party_id,gp_number,l_description,l_seller_weight,l_buyer_weight,l_rate,l_debit,l_credit,l_balance,l_date)" +
        +"values('" +
        data.party_id +
        "','" +
        data.gp_number +
...
function addIntoLedgerWithCV(data) {
  return new Promise(function (resolve, reject) {
    ...
    app.conn.query(query1, function (err, result1) {
      ...
      (query =
        "insert into ledger(party_id,cv_number,l_description,l_seller_weight,l_buyer_weight,l_rate,l_debit,l_credit,l_balance,l_date)" +
        +"values('" +
        data.party_id +
        "','" +
        data.cv_number +
...
function getTotalExpenses(party_id, date_from, date_to) {
  return new Promise(function (resolve, reject) {
    query =
      "select * from ledger where l_debit=0 and l_credit!=0 and l_date>='" +
      date_from +
      "' AND l_date<='" +
      date_to +
      "' AND party_id = '" +
...
function getTotalBalance(party_id, date_from, date_to) {
  return new Promise(function (resolve, reject) {
    query =
      "select l_balance as balance from ledger where l_date>='" +
      date_from +
      "' AND l_date<='" +
      date_to +
      "' AND party_id = '" +
...
function getTotalWeightsIn(party_id, date_from, date_to) {
  return new Promise(function (resolve, reject) {
    query =
      "select ifnull(sum(l_seller_weight),0) as total_weight_in from ledger where l_debit=0 and l_credit!=0 and l_date>='" +
      date_from +
      "' AND l_date<='" +
      date_to +
      "' AND party_id = '" +
...
function getTotalWeightsOut(party_id, date_from, date_to) {
  return new Promise(function (resolve, reject) {
    query =
      "select ifnull(sum(l_seller_weight),0) as total_weight_out from ledger where l_debit!=0 and l_credit=0 and l_date>='" +
      date_from +
      "' AND l_date<='" +
      date_to +
      "' AND party_id = '" +
