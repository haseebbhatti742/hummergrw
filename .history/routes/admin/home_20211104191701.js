...
router.get("/", async function (req, res) {
  if (req.session.username == undefined) {
    ...
    total_recoveries = total_recoveries.toFixed(2);
    balance_amount = balance_amount.toFixed(2);
    total_weight_in = total_weight_in.toFixed(2);
    total_weight_out = total_weight_out.toFixed(2);
    balance_weight = balance_weight.toFixed(2);
